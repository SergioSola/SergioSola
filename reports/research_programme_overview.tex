...
\end{itemize}
\textbf{$\rightarrow$ Link to Module 3}: The combined system matrix $\mathcal{W}_t$ is the direct input to the spectral analysis. The HLI is the largest eigenvalue of $W_t$.
...
\item GTC (Global Tail Cycle): common factor in left-tail co-movements (from Project 2)
...
\end{itemize}
\textbf{Data}: BIS LBS (NBFI counterparty decomposition), IMF IFS (financial conditions), Jarocinski-Karadi MP shocks, GFC from Project 2, GTC from Project 2.
